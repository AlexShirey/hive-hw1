...
echo "1 - count flights per carrier"
echo "2 - count flights by NYC in June"
echo "3 - count most 5 busy airports in summer"
echo "4 - count carrier with biggest number of flights"
...
case $OPTION in
        ...
        3) HQL="$(awk '/03_hql/{getline; print}' $config_file)" ;;
        4) HQL="$(awk '/04_hql/{getline; print}' $config_file)" ;;
